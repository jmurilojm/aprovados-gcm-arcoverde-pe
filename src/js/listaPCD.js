...
const candidatosPCD = [
  ...
  { 
    "matricula": "0215226", 
    "nome": "RALF WANDER LEITE DE LIMA", 
    "taf": false, 
    "psi": false, 
    "fic": "aguardando", 
    "em": "aguardando", 
  ...
  { 
    "matricula": "0226175", 
    "nome": "JOSENILDO BEZERRA DA SILVA", 
    "taf": "aguardando", 
    "psi": "aguardando", 
    "fic": "aguardando", 
    "em": "aguardando", 
  ...
  { 
    "matricula": "0214575", 
    "nome": "ALESSANDRO LESSA RODRIGUES", 
    "taf": true, 
    "psi": true, 
    "fic": true, 
    "em": true, 
  ...
  { 
    "matricula": "0236630", 
    "nome": "JOSE HENRIQUE INACIO DANTAS", 
    "taf": true, 
    "psi": true, 
    "fic": true, 
    "em": true, 
  ...
  { 
    "matricula": "0213453", 
    "nome": "KATIA MARIA FERREIRA PIMENTEL", 
    "taf": "aguardando", 
    "psi": "aguardando", 
    "fic": "aguardando", 
    "em": "aguardando", 
  ...
  { 
    "matricula": "0222611", 
    "nome": "WAGNER HENRIQUE PEREIRA CRISOSTOMO", 
    "taf": "aguardando", 
    "psi": "aguardando", 
    "fic": "aguardando", 
    "em": "aguardando", 
